...
import apple from '../../footer1.jpeg'
import GooglePlay from '../../footer2.jpeg'
import './Footer.css'
                 ...
                 <div className="col-12 col-lg-4 text-lg-center py-sm-3  ps-4 ps-lg-0">
                     ...
                     <div>
                         <Link className="nav-link active p-2 fw-bold text-white" aria-current="page" to="#">
                             <img className="img-footer" src={GooglePlay} alt="" /> </Link>

                     </div>
                     <div>
                         <Link className="nav-link active p-2 fw-bold text-white" aria-current="page" to="#">
                             <img className="img-footer" src={apple} alt="" /> </Link>
